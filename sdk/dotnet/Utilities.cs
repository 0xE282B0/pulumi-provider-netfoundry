...
namespace Pulumi.NetFoundry
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.NetFoundry.version.txt");
    ...
    internal sealed class NetFoundryResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public NetFoundryResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
