...
import (
	...
	providerVersion "github.com/0xe282b0/pulumi-netfoundry/provider/pkg/version"
...
// BaseDir is the path to the base pulumi-netfoundry directory.
var BaseDir string
...
func main() {
	flag.Usage = func() {
		const usageFormat = "Usage: %s <language> <swagger-or-schema-file> <root-pulumi-netfoundry-dir>"
